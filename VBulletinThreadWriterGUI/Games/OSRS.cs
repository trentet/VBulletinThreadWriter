...
namespace VBulletinThreadWriterGUI.Games
{
    public class OSRS : Game
    {
        public OSRS() : base("OSRS", new List<Skill>())
        {
            ...
            {
                Agility(),
                new Games.OSRS.Skills.Construction(),
                new Games.OSRS.Skills.Cooking(),
                new Games.OSRS.Skills.Crafting(),
                new Games.OSRS.Skills.Farming(),
                new Games.OSRS.Skills.Firemaking(),
                new Games.OSRS.Skills.Fishing(),
                new Games.OSRS.Skills.Fletching(),
                new Games.OSRS.Skills.Herblore(),
                new Games.OSRS.Skills.Hunter(),
                new Games.OSRS.Skills.Magic(),
                new Games.OSRS.Skills.Melee(),
                new Games.OSRS.Skills.Mining(),
                new Games.OSRS.Skills.Prayer(),
                new Games.OSRS.Skills.Ranged(),
                new Games.OSRS.Skills.Runecrafting(),
                new Games.OSRS.Skills.Slayer(),
                new Games.OSRS.Skills.Smithing(),
                new Games.OSRS.Skills.Thieving(),
                new Games.OSRS.Skills.Woodcutting()
            };
        }
